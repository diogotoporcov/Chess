...
public sealed class CastlingMoveExecutionResolver : IMoveExecutionResolver
{
    public bool CanResolve(
        Move move)
    {
        return move.OptionId == MoveOptions.CastleKingSide ||
        ...
        Move move)
    {
        ...
        var transition = new BoardTransition(
            new BoardSquareChange(plan.KingFrom, king, null),
            new BoardSquareChange(plan.KingTo, null, king),
            new BoardSquareChange(plan.RookFrom, rook, null),
            new BoardSquareChange(plan.RookTo, null, rook));
